...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Sparse reconstruction using COLMAP',
                                     formatter_class=argparse.ArgumentDefaultsHelpFormatter)
    parser.add_argument("--colmap_exe_path", type=str)
    ...
    "{} mapper --database_path {} --image_path {} --output_path {}".format(
        colmap_exe_path, database_path, image_root, output_root))