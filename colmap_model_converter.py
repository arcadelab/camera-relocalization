...
if __name__ == "__main__":
    ...
    parser.add_argument("--fill_dreco_db", action="store_true")
    ...
    for result_path in result_path_list:
        ...
        command = 'colmap model_converter --input_path {} --output_path {} --output_type TXT'.format(result_path, result_path)
        ...
        if not os.path.exists(str(result_path / mask_path.name)):
